...
class ViewController: UIViewController {
    ...
    let sections = ["Meyveler", "Hayvanlar", "Arabalar"]
    // Array tipinde bir değişken oluşturup içine String atadık.
    var ürünler = [["Elma", "Armut", "Kavun", "Kiraz"], ["Kedi", "Köpek", "At"], ["Audi", "Vw", "Mercedes"]]
...
extension ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.colorLabel.text = self.ürünler[indexPath.section][indexPath.row]
